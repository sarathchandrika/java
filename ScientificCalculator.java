...
public class ScientificCalculator extends JFrame implements ActionListener {
	...
	JButton b1, b2, b3, b4, b5, b6, b7, b8, b9, zero, clr, pow2, pow3, exp,
			...
			mm, sqrt, sin, cos, tan,frac;
	Container cont;
	JPanel textPanel, buttonpanel;

public void print(Fraction ans)
{
    tfield.setText(Double.toString(ans.getNum())+"/"+Double.toString(ans.getDen()));
}
	...
	public void actionPerformed(ActionEvent e)
    {
		...
		if (s.equals("Add"))
        {
            ...
            else
            {
                ...
                {
                                    String [] retval = tfield.getText().split("/");
                                    o1.setDen(Double.parseDouble(retval[1]));
                                    o1.setNum(Double.parseDouble(retval[0]));
                }
                else
                {
		...
		if (s.equals("="))
        {
            ...
            else
            {
                            ...
                            {
                                    String [] retval = tfield.getText().split("/");
                                    o2.setDen(Double.parseDouble(retval[1]));
                                    o2.setNum(Double.parseDouble(retval[0]));
                                    switch (ch)
                                    {
                                        case '+':
                                                    o1.fracAddition(o2);
...
class Fraction
{
    ...
    public void fracAddition(Fraction temp)
    {
        ...
        {
            double x =(temp.denominator)*(this.denominator);
            double y=(this.numerator*temp.denominator)+(temp.numerator*this.denominator);
            this.denominator=x;
            this.numerator=y;
        }
        this.reduce();
    ...
    public void fracSubtraction(Fraction temp)
    {
        if((temp.numerator==0&&this.numerator==0)||(temp.denominator==0&&this.denominator==0))
        {
            this.denominator=0;
    ...
    public void fracMultiply(Fraction temp)
    {
        double x=(temp.denominator)*(this.denominator);
        double y=(temp.numerator)*(this.numerator);
        this.denominator=x;
        this.numerator=y;
        this.reduce();
    }

    public void fracDivision(Fraction temp)
    {
        double x=temp.numerator;
        double y=temp.denominator;
        temp.numerator=y;
        temp.denominator=x;
        this.fracMultiply(temp);
    }
}
